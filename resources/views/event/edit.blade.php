                    ...
                    <form action=" {{route('event.update', $event->id)}} " method="post" enctype="multipart/form-data">
                        ...
                        {{-- @method('PUT') --}}
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value=" {{$event->judul}} " name="judul" required>
                            </div>
                            <div class="form-group">
                                <label for="">Masukkan Isi Berita</label>
                                <textarea name="berita" class="form-control"  id="" cols="30" rows="10" required> {{$event->berita}} </textarea>
                            </div>
                            <div class="form-group">
